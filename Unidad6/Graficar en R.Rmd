...
```{r}
reads<-read.delim("Prac_Uni6/data/reads.txt")
```
...
```{r}
# cargar archivo
maiz.tree<-read.nexus("Prac_Uni6/data/tree")
...
fullmat<-read.delim("Prac_Uni6/meta/maizteocintle_SNP50k_meta_extended.txt")
...
```{r}
# leer shapefile
biogeo<-readShapePoly("Prac_Uni6/data/rbiog4mgw/rbiog4mgw.shp")
